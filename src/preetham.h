...
inline PreethamSkyData computeSkyData(glm::vec3 sun_direction, float turbidity, float normalizedSunY) {
    ...
    //compute {x distribution, y distribution, luminance distribution}
    ...
    glm::vec3 Z = {
        zenith_chromacity(glm::vec4(0.00166, -0.00375, 0.00209, 0), 
                          glm::vec4(-0.02903, 0.06377, -0.03202, 0.00394), 
                          glm::vec4(0.11693, -0.21196, 0.06052, 0.25886), 
                          sunTheta, turbidity
        ),
        zenith_chromacity(glm::vec4(0.00275, -0.00610, 0.00317, 0), 
